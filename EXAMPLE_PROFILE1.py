...
CLprobe="3x2pt"
#CLprobe="shear_shear"
#path= os.environ['ROOTDIR'] + "/external_modules/data/roman_real"
path= os.environ['ROOTDIR'] + "/projects/roman_real/data"
data_file="roman_real.dataset" #This is where we specify things like which files to use and ntomo

IA_model = 0 #need to figure out what these numbers correspond to
